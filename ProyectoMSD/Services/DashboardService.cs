...
public class DashboardService : IDashboardService
{
    ...
    public async Task<DashboardMetricsDto> GetUserMetricsAsync(int userId)
    {
        ...
        // 1. KPIs del Usuario (Filtrados por propiedad/usuarios_propiedades)
        ...
        dto.TotalDispositivos = await _db.Dispositivos
            .Where(d => _db.Espacios.Where(e => propiedadesIds.Contains(e.IdPropiedades)).Select(e => e.Id).Contains(d.IdEspacio))
            .CountAsync();

        // 2. Soportes del Usuario
